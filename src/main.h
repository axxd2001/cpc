...
public:
    ...
    {
        // Chinesepaintingcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Chinesepaintingcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Chinesepaintingcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Chinesepaintingcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Chinesepaintingcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Chinesepaintingcoin: block index flags
    enum  
    {
