...
const QString BITCOIN_IPC_PREFIX("Chinesepaintingcoin:");
...
{
    QString name("ChinesepaintingcoinQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Chinesepaintingcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Chinesepaintingcoin: click-to-pay handler");
    else
...
{
    // clicking on Chinesepaintingcoin: URLs creates FileOpen events on the Mac:
